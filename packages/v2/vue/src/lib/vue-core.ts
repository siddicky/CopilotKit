...
/**
 * Vue-specific extension of `CopilotKitCore` that adds support for
 * managing render tool calls, activity message renderers, and custom
 * message renderers with change notifications.
 */
export class CopilotKitCoreVue extends CopilotKitCore {
  ...
  override subscribe(subscriber: CopilotKitCoreVueSubscriber): CopilotKitCoreSubscription {
